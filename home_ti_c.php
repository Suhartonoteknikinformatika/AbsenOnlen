...
//$perintah=mysql_query($query);
	...
	echo "<html>
			...
			<body>";
	echo "<h3><font size='5' color='black'>Absen Harian Tehnik Informatika Kelas C</font></h3>
		<table border=3>
	  	  <tr>
 	  	  	<td>NIM</td>
 	  	  	<td>NAMA</td>
...
{
	echo "<form method='post' action='hasil_ti_c.php'>";
	echo "<tr>	  
    ...
    echo 	"<td><a href=hapus_mahasiswa_ti_c.php?nim=$data[NIM] onclick='return confirm_hapus()'>Hapus</a></td>";
	...
	echo "<a href=home.php>Kembali</a>&nbsp
		...
		<a href=tambah_mahasiswa_ti_c.php>Tambah Mahasiswa</a>
		</body>
		</html>";
?>
